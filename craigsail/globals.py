CRAIGSLIST_CITIES = {
    ...
    'Delaware': ['delaware'],
    'Florida': ['daytona beach', 'florida keys', 'ft myers / SW florida', 'gainesville', 'heartland florida', 'jacksonville', 'lakeland', 'north central FL', 'ocala', 'okaloosa / walton', 'orlando', 'panama city', 'pensacola', 'sarasota-bradenton', 'south florida', 'space coast', 'st augustine', 'tallahassee', 'tampa bay area', 'treasure coast', 'west palm beach'],
    ...
    'Maine': ['maine'],
    'Maryland': ['annapolis', 'baltimore', 'cumberland valley', 'eastern shore', 'frederick', 'southern maryland', 'western maryland'],
    ...
    'Ohio': ['akron / canton', 'ashtabula', 'athens', 'chillicothe', 'cincinnati', 'cleveland', 'columbus', 'dayton / springfield', 'lima / findlay', 'mansfield', 'northern panhandle', 'parkersburg-marietta', 'sandusky', 'toledo', 'tuscarawas co', 'youngstown', 'zanesville / cambridge'],
